...
#define IIC_COMMANDS_SEND_ALL_DATA "4C"
...
typedef void (*iic_data_received_from_slave_event_handler_t)(connected_device_t * pConnectedDevice);
typedef void (*iic_command_received_from_master_event_handler_t)(const char * command);
